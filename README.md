...
# Cesar Cipher: an ancient encryption method that was used to hide military messages. It can be replicated in Pythin using functions and for loops:
...
#10 - Basic game using the input function:
